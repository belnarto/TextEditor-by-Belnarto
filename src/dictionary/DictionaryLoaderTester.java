...
public class DictionaryLoaderTester {
	...
	public void TestEmptyFile() {
			DictionaryLoader.loadDictionary(Dict, "data/DictEmpty.txt");
	...
	public void TestNumWordsInLineAndLeadingSpaces() {
			DictionaryLoader.loadDictionary(Dict, "data/DictNumWordsInLine.txt");
	...
	public void TestFileWithEmptyLines() {
			DictionaryLoader.loadDictionary(Dict, "data/DictWithEmptyLines.txt");
	...
	public void TestFileEnded() {
			...
			DictionaryLoader.loadDictionary(Dict, "data/Dict4k.txt", 5000);
	...
	public void Test100WordsLoading() {
			DictionaryLoader.loadDictionary(Dict, "data/Dict4k.txt", 100);
	...
	public void TestFullDictLoading() {
			DictionaryLoader.loadDictionary(Dict, "data/Dict4k.txt");
